...
var channelTemplates = []ChannelTemplate{
	...
	},
	{
		...
		DisplayFields: []DisplayField{
			...
			{Key: "secondary_used_pct", Label: "Secondary Window Used %", ValueRef: "secondary_used_pct", Format: "percentage", DisplayOrder: 2},
			{Key: "secondary_reset", Label: "Secondary Reset At", ValueRef: "secondary_reset", Format: "datetime", DisplayOrder: 3},
			{Key: "plan_type", Label: "Plan Type", ValueRef: "plan_type", Format: "text", DisplayOrder: 4, Badge: "plan", BadgePresets: `{"free":"sapphire","plus":"rosegold","pro":"champagne","team":"champagne"}`},
		},
	},
	{
