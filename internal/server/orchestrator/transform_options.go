...
func applyTransformOptions(req *llm.Request, channelSettings *objects.ChannelSettings) *llm.Request {
	...
	// Default disabled (nil or false); only an explicit true enables the serializer-side
	// compatibility transform. Preserve explicit false so downstream behavior remains clear.
