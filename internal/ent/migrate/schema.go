...
var (
	...
	UsageMonitorChannelsColumns = []*schema.Column{
		...
		{Name: "provider_type", Type: field.TypeEnum, Nullable: true, Enums: []string{"claudecode", "codex", "github_copilot", "nanogpt", "cline", "wafer", "synthetic", "neuralwatt", "zhipu", "antigravity", "apertis", "opencode_go"}},
