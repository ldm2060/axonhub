...
func TestV0_1_67_BackfillsLegacyInvitationRoles(t *testing.T) {
	...
	require.NoError(t, datamigrate.NewV0_1_67().Migrate(ctx, client))
	require.NoError(t, datamigrate.NewV0_1_67().Migrate(ctx, client))
...
func TestV0_1_67_CreatesMissingDefaultDeveloperRole(t *testing.T) {
...
func TestV0_1_67_SkipsRevokedLegacyInvitations(t *testing.T) {
...
func TestV0_1_67_PreservesUnrelatedSoftDeletedDeveloper(t *testing.T) {
...
func TestV0_1_67_CleansSoftDeletedDeveloperAndRecreates(t *testing.T) {
...
func TestV0_1_67_SkipsExpiredAndExhaustedInvitations(t *testing.T) {
