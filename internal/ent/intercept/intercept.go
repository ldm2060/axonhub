...
// The EmailTokenFunc type is an adapter to allow the use of ordinary function as a Querier.
type EmailTokenFunc func(context.Context, *ent.EmailTokenQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f EmailTokenFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.EmailTokenQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.EmailTokenQuery", q)
}

// The TraverseEmailToken type is an adapter to allow the use of ordinary function as Traverser.
type TraverseEmailToken func(context.Context, *ent.EmailTokenQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseEmailToken) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseEmailToken) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EmailTokenQuery); ok {
		return f(ctx, q)
	}
...
// The PublishRequestFunc type is an adapter to allow the use of ordinary function as a Querier.
type PublishRequestFunc func(context.Context, *ent.PublishRequestQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f PublishRequestFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.PublishRequestQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.PublishRequestQuery", q)
}

// The TraversePublishRequest type is an adapter to allow the use of ordinary function as Traverser.
type TraversePublishRequest func(context.Context, *ent.PublishRequestQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraversePublishRequest) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraversePublishRequest) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PublishRequestQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.PublishRequestQuery", q)
}
...
// The UsageMonitorChannelFunc type is an adapter to allow the use of ordinary function as a Querier.
type UsageMonitorChannelFunc func(context.Context, *ent.UsageMonitorChannelQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UsageMonitorChannelFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UsageMonitorChannelQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UsageMonitorChannelQuery", q)
}

// The TraverseUsageMonitorChannel type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUsageMonitorChannel func(context.Context, *ent.UsageMonitorChannelQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUsageMonitorChannel) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUsageMonitorChannel) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UsageMonitorChannelQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UsageMonitorChannelQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.PublishRequestQuery:
		return &query[*ent.PublishRequestQuery, predicate.PublishRequest, publishrequest.OrderOption]{typ: ent.TypePublishRequest, tq: q}, nil
	...
	case *ent.UsageMonitorChannelQuery:
		return &query[*ent.UsageMonitorChannelQuery, predicate.UsageMonitorChannel, usagemonitorchannel.OrderOption]{typ: ent.TypeUsageMonitorChannel, tq: q}, nil
	case *ent.UserQuery:
