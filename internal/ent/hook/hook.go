...
// The ChannelUsageMonitorBindingFunc type is an adapter to allow the use of ordinary
// function as ChannelUsageMonitorBinding mutator.
type ChannelUsageMonitorBindingFunc func(context.Context, *ent.ChannelUsageMonitorBindingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ChannelUsageMonitorBindingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ChannelUsageMonitorBindingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ChannelUsageMonitorBindingMutation", m)
}
...
// The EmailTokenFunc type is an adapter to allow the use of ordinary
// function as EmailToken mutator.
type EmailTokenFunc func(context.Context, *ent.EmailTokenMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f EmailTokenFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EmailTokenMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.EmailTokenMutation", m)
}
...
// The UserUsageStatsFunc type is an adapter to allow the use of ordinary
// function as UserUsageStats mutator.
type UserUsageStatsFunc func(context.Context, *ent.UserUsageStatsMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserUsageStatsFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserUsageStatsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserUsageStatsMutation", m)
}
