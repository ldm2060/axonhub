...
func (_m *Channel) Node(ctx context.Context) (node *Node, err error) {
	...
	node.Edges[8] = &Edge{
		...
		Name: "quota_monitor_bindings",
	}
	err = _m.QueryQuotaMonitorBindings().
		Select(channelusagemonitorbinding.FieldID).
...
// Node implements Noder interface
func (_m *ChannelUsageMonitorBinding) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "ChannelUsageMonitorBinding",
		Fields: make([]*Field, 9),
	...
	if buf, err = json.Marshal(_m.UsageMonitorChannelID); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int",
		Name:  "usage_monitor_channel_id",
		Value: string(buf),
	}
	...
	if buf, err = json.Marshal(_m.TriggerStatuses); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "[]string",
	...
	if buf, err = json.Marshal(_m.Conditions); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "[]objects.QuotaMonitorBindingCondition",
		Name:  "conditions",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.LastTriggeredAt); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(_m.LastTriggerReason); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "string",
		Name:  "last_trigger_reason",
		Value: string(buf),
	}
	node.Edges[0] = &Edge{
		Type: "Channel",
	...
	node.Edges[1] = &Edge{
		Type: "UsageMonitorChannel",
		Name: "usage_monitor_channel",
	}
	err = _m.QueryUsageMonitorChannel().
		Select(usagemonitorchannel.FieldID).
		Scan(ctx, &node.Edges[1].IDs)
	if err != nil {
		return nil, err
...
// Node implements Noder interface
func (_m *EmailToken) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "EmailToken",
		Fields: make([]*Field, 8),
	...
	if buf, err = json.Marshal(_m.Token); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
...
func (_m *User) Node(ctx context.Context) (node *Node, err error) {
	...
	err = _m.QueryEmailTokens().
		Select(emailtoken.FieldID).
...
// Node implements Noder interface
func (_m *UserUsageStats) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "UserUsageStats",
		Fields: make([]*Field, 10),
	...
	if buf, err = json.Marshal(_m.LastActiveAt); err != nil {
		return nil, err
	}
	node.Fields[9] = &Field{
		Type:  "time.Time",
