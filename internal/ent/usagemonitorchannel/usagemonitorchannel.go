...
func ProviderTypeValidator(pt ProviderType) error {
	switch pt {
	case ProviderTypeClaudecode, ProviderTypeCodex, ProviderTypeGithubCopilot, ProviderTypeNanogpt, ProviderTypeWafer, ProviderTypeSynthetic, ProviderTypeNeuralwatt, ProviderTypeZhipu, ProviderTypeAntigravity:
		return nil
	default:
