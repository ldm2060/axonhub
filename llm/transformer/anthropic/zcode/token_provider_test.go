...
func newTestServer(t *testing.T, ts *testServer) (tokenURL, businessURL string) {
	...
	tokenSrv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		require.Equal(t, "ZCode/"+AppVersion, r.Header.Get("User-Agent"))
		require.Equal(t, EndpointOriginProduction, r.Header.Get("Http-Referer"))
		require.Equal(t, AppVersion, r.Header.Get("X-Zcode-App-Version"))
		require.Equal(t, "Z Code@electron", r.Header.Get("X-Title"))
		require.NotEmpty(t, r.Header.Get("X-Request-ID"))
		require.NotEmpty(t, r.Header.Get("X-Os-Category"))
		require.NotEmpty(t, r.Header.Get("X-Os-Version"))
