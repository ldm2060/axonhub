...
export function RuntimeOverview() {
  ...
  return <div className='space-y-6'>
    ...
    <div className='grid gap-6 xl:grid-cols-2'>
      <Card>
        <CardHeader><CardTitle>{t('runtime.charts.resources')}</CardTitle><CardDescription>{t('runtime.charts.lastThreeHours')}</CardDescription></CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader><CardTitle>{t('runtime.charts.network')}</CardTitle><CardDescription>{t('runtime.charts.lastThreeHours')}</CardDescription></CardHeader>
        <CardContent>
          <ResponsiveContainer width='100%' height={290}>
            <AreaChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              <defs>
    ...
    <div className='grid gap-6 xl:grid-cols-3'>
      <Card className='xl:col-span-2'>
        <CardHeader><CardTitle>{t('runtime.charts.processMemory')}</CardTitle><CardDescription>{t('runtime.charts.processMemoryDescription')}</CardDescription></CardHeader>
        <CardContent>
