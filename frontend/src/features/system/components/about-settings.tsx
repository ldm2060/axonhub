          ...
          <div className='border-t pt-6'>
            ...
            <div className='flex flex-wrap gap-4'>
              <Button variant='outline' size='sm' asChild>
                <a href='https://github.com/ldm2060/axonhub' target='_blank' rel='noopener noreferrer'>
                  GitHub
                  <ExternalLink className='ml-1 h-3 w-3' />
                </a>
              </Button>
              <Button variant='outline' size='sm' asChild>
                <a href='https://github.com/ldm2060/axonhub/releases' target='_blank' rel='noopener noreferrer'>
                  {t('system.about.links.releases')}
                  <ExternalLink className='ml-1 h-3 w-3' />
                </a>
              </Button>
              <Button variant='outline' size='sm' asChild>
                <a href='https://github.com/ldm2060/axonhub/issues' target='_blank' rel='noopener noreferrer'>
