...
export function useArchiveTrace() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const data = await graphqlRequest<{ archiveTrace: boolean }>(`mutation ArchiveTrace($id: ID!) { archiveTrace(id: $id) }`, { id });
...
export function useUnarchiveTrace() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const data = await graphqlRequest<{ unarchiveTrace: boolean }>(`mutation UnarchiveTrace($id: ID!) { unarchiveTrace(id: $id) }`, {
        id,
      });
...
export function useRetainTrace() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const data = await graphqlRequest<{ retainTrace: boolean }>(`mutation RetainTrace($id: ID!) { retainTrace(id: $id) }`, { id });
...
export function useUnretainTrace() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const data = await graphqlRequest<{ unretainTrace: boolean }>(`mutation UnretainTrace($id: ID!) { unretainTrace(id: $id) }`, { id });
