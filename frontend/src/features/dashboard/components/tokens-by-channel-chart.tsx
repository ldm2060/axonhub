...
export function TokensByChannelChart({ timePeriod, mode }: TokensByChannelChartProps) {
  const { t } = useTranslation();
  const { data: tokenData, isLoading, isFetching, error } = useTokensByChannel(timePeriod, mode);
