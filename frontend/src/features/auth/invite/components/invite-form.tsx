...
type InviteFormProps = HTMLAttributes<HTMLFormElement> & {
  token: string;
};
...
export function InviteForm({ token, className, ...props }: InviteFormProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      const response = await authApi.registerInvitation(token, values);
