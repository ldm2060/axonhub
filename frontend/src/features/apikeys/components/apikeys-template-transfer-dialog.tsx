...
function exportApiKeyProfileTemplate(template: ApiKeyProfileTemplate) {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className='sm:max-w-lg'>
          ...
          <DialogFooter className='gap-2'>
            ...
            <Button onClick={handleSubmit} disabled={!canSubmit} variant={matchingTemplate ? 'destructive' : 'default'} className='gap-2'>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t('apikeys.templates.overwriteConfirmDescription', {
                name: matchingTemplate?.name ?? name.trim(),
