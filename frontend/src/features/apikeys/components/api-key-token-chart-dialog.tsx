                  ...
                  <Table>
                    ...
                    <TableBody>
                      ...
                      <TableRow>
                        ...
                        <TableCell className='text-center tabular-nums'>{pct(stat.cachedTokens, stat.inputTokens)}%</TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell className='text-center tabular-nums'>{pct(stat.reasoningTokens, stat.outputTokens)}%</TableCell>
                      </TableRow>
                              ...
                              <TableBody>
                                ...
                                <TableRow>
                                  <TableCell className='font-medium whitespace-nowrap'>
                                    {t('apikeys.tokenUsageChart.cacheHitRate')}
                                  </TableCell>
                                ...
                                <TableRow>
                                  <TableCell className='font-medium whitespace-nowrap'>
                                    {t('apikeys.tokenUsageChart.reasoningRatio')}
                                  </TableCell>
