...
export function ChannelsAvailabilityDialog({ open, onOpenChange, currentRow }: Props) {
      ...
      await updateChannel.mutateAsync({
        ...
        input: {
          policies: {
            ...
            availability: currentPolicies?.availability,
  ...
  }, [currentPolicies?.stream, currentPolicies?.availability, currentRow.id, mode, onOpenChange, rules, t, updateChannel]);
        ...
        {mode === 'inherit' && (
          <div className='space-y-3'>
            ...
            <Button variant='link' className='h-auto px-0' asChild>
              <Link to='/admin/system' search={{ tab: 'retry' }}>
