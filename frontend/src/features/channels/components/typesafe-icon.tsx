...
export const TypeSafeIcon: React.FC<TypeSafeIconProps> = ({ size = 20, className = '', style = {}, ...rest }) => {
  return (
    <svg
      height={size}
    ...
    >
      ...
      <path d='M81.5 78L84.5 81L90.5 75' stroke='#FFFFFF' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
};
